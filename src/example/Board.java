...
public class Board {
	...
	Board(int numOfPlayers){
		...
		connections[40] = new Connection(colors[6], towns[0], towns[1], 1, 1);			connections[50] = new Connection(colors[6], towns[0], towns[1], 1, 1);	
		connections[41] = new Connection(colors[6], towns[0], towns[1], 1, 1);			connections[51] = new Connection(colors[6], towns[0], towns[1], 1, 1);	
		connections[42] = new Connection(colors[6], towns[0], towns[1], 1, 1);			connections[52] = new Connection(colors[6], towns[0], towns[1], 1, 1);	
		connections[43] = new Connection(colors[6], towns[0], towns[1], 1, 1);			connections[53] = new Connection(colors[6], towns[0], towns[1], 1, 1);	
		connections[44] = new Connection(colors[6], towns[0], towns[1], 1, 1);			connections[54] = new Connection(colors[6], towns[0], towns[1], 1, 1);	
		connections[45] = new Connection(colors[6], towns[0], towns[1], 1, 1);			connections[55] = new Connection(colors[6], towns[0], towns[1], 1, 1);	
